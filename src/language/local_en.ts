...
export default {
	...
	notify: {
		...
		memories_desc:
			"Ao.space helped you sort out some past memories. Go to review them~",
	...
	breadcrumb: {
		select_files:
			"{count} file has been selected | {count} files have been selected",
	},
	space: {
		home_photo: "Photos",
		home_all: "All",
		...
		folder: "Folder",
		file_name_only:
			"The file name only supports Chinese, English, numbers and underscores",
		rename_success: "Rename Success",
		rename_fail: "Rename Fail",
		create_success: "Create Success",
		create_fail: "Create Fail",
		copy_fail_contains:
			"Copy fail, destination directory already contains {name}",
		move_fail_contains:
			"Move fail, destination directory already contains {name}",
	...
	recycle: {
		...
		restore_desc:
			"Are you sure to restore {name}？ | Are you sure to restore these files？",
	...
	setting: {
		...
		domain_name_tips:
			"* Domain name can only be edited on bound mobile phones.",
	...
	safe: {
		...
		bound_reject:
			"Reason: The administrator rejected this operation on the binding side",
	...
	downUpload: {
		...
		no_exist:
			"The file has been deleted or moved. Please refresh and try again",
	},
	login: {
		...
		phone_show_code:
			"Please enter the {num}-digit authorization code displayed on your phone",
		domain_login: "Domain / Space Login",
		input_domain: "Please enter the domain name / space ID",
		domain_name: "Example: ***. ao.space or Xiao Ao***",
		space_not_found:
			"The space ID not exist. Please check if the input is correct",
	...
	error: {
		...
		offline_notify:
			"Device offline, please check the device or network condition",
